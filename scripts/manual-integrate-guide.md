...
- **Your repo**: `apps/better-ccusage/` (with Zai/GLM-4.5, GLM-4.6, GLM-4.7, kat-coder custom features)
...
- GLM-4.5, GLM-4.6, GLM-4.7, kat-coder model pricing
...
- [ ] GLM-4.5, GLM-4.6, GLM-4.7, kat-coder models still recognized
