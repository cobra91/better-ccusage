...
### 🚀 GLM-4.5, GLM-4.6, GLM-4.7, GLM-5, kat-coder Model Support

- Full support for GLM-4.5, GLM-4.6, GLM-4.7, GLM-5, kat-coder models from various providers
- Token counting and cost calculation optimized for GLM-4.5, GLM-4.6, GLM-4.7, GLM-5, kat-coder (beta)
...
better-ccusage was created to address a limitation in the original ccusage project: while ccusage focuses exclusively on Claude Code usage with Anthropic models, better-ccusage extends support to external tools/providers that use Claude Code/Droid with different providers like Zai, Dashcope and many models like GLM-4.5, GLM-4.6, GLM-4.7, GLM-5 kat-coder, kimi, MiniMax etc.

The original ccusage project doesn't account for:

- **Zai** providers that use Claude Code infrastructure with their own models
- **GLM-4.5, GLM-4.6, GLM-4.7, GLM-5, kat-coder** models from other AI providers
